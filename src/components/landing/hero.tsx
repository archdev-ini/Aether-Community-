  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 max-w-4xl px-4">
        <h1 className="font-headline text-5xl font-bold leading-tight drop-shadow-md md:text-7xl">
        ...
        <div className="mt-10 flex flex-col items-center justify-center gap-4 sm:flex-row">
          ...
          <Button asChild variant="outline" size="lg" className="border-white bg-transparent text-white hover:bg-white hover:text-black">
